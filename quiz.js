...
var $indicators = $('<ol>')
  ...
  */
        ...
        function next() {
          ...
          if (last_question) {
            ...
            $results_ratio.text(
              ...
              "% das questões você respondeu que sim!"
            );
  ...
  var $social = $("<div>")
    ...
    .html('<a href= "https://www.pensador.com/textos_sobre_a_mulher/">Aqui pode ser um site da delegacia, não sei</a>')
    .appendTo($results_slide);
...
function resultsText(state) {
  ...
  switch (true) {
    ...
    case (ratio > 0.9):
      ...
      break;
    case (ratio > 0.5):
      text = "Você pode está caindo em um relacionamento abusivo, preste atenção. Converse com o seu parceiro. Procure ajuda para que eles possam te ajudar a começar esse diálogo. LINKS ABAIXO!!!";
      break;
    case (ratio < 0.5 && ratio !== 0):
      ...
      break;
    case (ratio === 0):
      text = "Você não está em um relacionamento abusivo, mas se você já presenciou situações com amigos, familiares envolvendo uma dessas questões, aletem-as!!!";
      break;
  }
  return text;
